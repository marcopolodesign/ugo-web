  ...
  <div class="w-60-ns pt5 pl4  relative overflow-y-scroll reserve-input-container">
    ...
    <form class="form-container form-mobile">
      ...
      <div class="form-final">
        <h2 class="w-90-ns dn">Todo listo! Podes pagar ahora o elegir que te contactemos en menos de 24hrs para confirmar la reserva.</h2>
        ...
        <div class="flex items-stretch final-options column-mobile">
            <div class="pay-now-container flex mr4-ns">
              <h2 class="m-auto tc">Pagar $<span id="final-number"></span> vía Mercado Pago</h2>
            </div>

            <div class="mail-now-container flex flex-column">
